        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                <a href="/" class="flex mr-4">
                  <img src="/img/logo/logo-yai.png" class="mr-3 h-8" alt="Smk Al-intisab Logo" />
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Smk Al-Intisab</span>
                </a>
              </div>
  
              <div class="hidden md:flex md:gap-x-10 lg:flex lg:gap-x-12">
                  <a href="/mading" class="text-sm font-semibold leading-6 text-gray-900 dark:text-white hover:text-gray-400">Mading</a>
                  <a href="/teams" class="text-sm font-semibold leading-6 text-gray-900 dark:text-white hover:text-gray-400">Teams</a>
                  <a href="/contact" class="text-sm font-semibold leading-6 text-gray-900 dark:text-white hover:text-gray-400">Contact</a>
                </div>
  
            <div class="flex items-center lg:order-2">
                <p class="hidden lg:flex md:flex text-sm font-semibold leading-6 text-gray-900 dark:text-white">{{ auth()->user()->name }}</p>
                <!-- Apps -->
                <button type="button" data-dropdown-toggle="apps-dropdown" class="p-2 text-gray-500 rounded-lg lg:hidden md:hidden hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
                    ...
                    <a href="/mading" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                      <svg class="mx-auto mb-2 w-5 h-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="text-sm font-medium text-gray-900 dark:text-white">Mading</div>
                    </a>
                    <a href="/teams" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 dark:text-white">Teams</div>
                      </a>
                      <a href="/contact" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                ...
                @auth
                  <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
                      ...
                      <ul class="py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                          <li>
                              <x-dropdown-link :href="route('profile.edit')" class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">My profile</x-dropdown-link>
                          </li>
                          {{-- <li>
                      ...
                      <ul class="py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                          ...
                          {{-- <li>
                              <a href="#" class="flex items-center py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                  ...
                                  {{-- <svg class="mr-2 w-4 h-4 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
