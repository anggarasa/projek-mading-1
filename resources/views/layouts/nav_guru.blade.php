      ...
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
            <span class="self-center text-base font-semibold whitespace-nowrap dark:text-white">Smk Al-intisab</span>
          </a>
        ...
        <div class="flex items-center lg:order-2">
          ...
          @auth
            ...
            >
              ...
              >
                <li>
                  <x-dropdown-link href="/profile-guru" class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">My profile</x-dropdown-link>
                </li>
              </ul>
              <ul
                class="py-1 text-gray-700 dark:text-gray-300"
