...
<main class="pt-8 pb-16 lg:pt-16 lg:pb-24 antialiased">
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
        <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <header class="mb-4 lg:mb-6 not-format">
                <address class="flex items-center mb-6 not-italic">
                    <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                        ...
                        <img class="mr-4 w-16 h-16 rounded-full" src="{{ asset('storage/'. $mading->author->profile) }}" alt="{{ $mading->name }}">
                        @else
                        <img class="mr-4 w-16 h-16 rounded-full" src="/img/logo/profile.jpg" alt="Jese Leos">
                        @endif
                        <div>
            ...
            <a href="/admin/madings" class="text-white no-underline bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Back to mading</a>
        </article>
    </div>
</main>
@endsection