...
<section>
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
            <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our Mading</h2>
            <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Anda bisa melihat informasi yang anda tambahkan disini dan juga anda bisa menghapus atau mengedit informasi anda</p>
        </div> 
          ...
          @foreach ($madings as $mading)
            ...
            <div class="group relative p-4">
              <h3 class="mt-3 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600 dark:text-white">
                <a href="/admin/madings/{{ $mading->id }}">
            ...
            <div class="flex items-center p-4 space-x-4">
              <a href="/admin/madings/{{ $mading->id }}/edit" class="text-white inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                  <svg aria-hidden="true" class="mr-1 -ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg>
                  Edit
              </a>   
              <form action="/admin/madings/{{ $mading->id }}" method="post">
                  @method('delete')
                  @csrf
