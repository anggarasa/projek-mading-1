<x-guest-layout>
    <form method="POST" action="/register-admin">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="role" aria-label="disabled input" class="block mt-1 w-full cursor-not-allowed" type="text" name="role" value="admin" selected required autocomplete="username" />
            <x-input-error :messages="$errors->get('email')" class="mt-2" />
        </div>
